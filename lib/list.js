...
module.exports = function (keystone) {
	...
	// Default Filters Field
	Object.defineProperty(List.prototype, 'defaultFilters', {
		get: function () {
			var df = this.get('defaultFilters');
			return (df === '__default__') ? [] : df;
		}, set: function (value) {
			this.set('defaultFilters', value);
		},
	});
